...
var symbolicNames = [ null, "SEMI", "WHITESPACE", "COMMENT", "WHILE", "LP", 
                      ...
                      "EQ", "TYPE", "STRING_CONSTANT", "ID" ];

var ruleNames =  [ "start", "program", "var_decl_list", "var_decl", "stmts", 
                   "stmt", "assign", "cond", "braceblock", "expr", "orexp", 
...
gramParser.RULE_expr = 9;
gramParser.RULE_orexp = 10;
gramParser.RULE_andexp = 11;
gramParser.RULE_notexp = 12;
gramParser.RULE_rel = 13;
gramParser.RULE_sum = 14;
gramParser.RULE_term = 15;
gramParser.RULE_neg = 16;
gramParser.RULE_factor = 17;
gramParser.RULE_return_stmt = 18;
gramParser.RULE_loop = 19;
...
gramParser.prototype.expr = function() {
    ...
    this.enterRule(localctx, 18, gramParser.RULE_expr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 95;
        this.orexp(0);
...
gramParser.prototype.orexp = function(_p) {
    ...
    var _startState = 20;
    this.enterRecursionRule(localctx, 20, gramParser.RULE_orexp, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 98;
        this.andexp(0);
...
gramParser.prototype.andexp = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 22;
    this.enterRecursionRule(localctx, 22, gramParser.RULE_andexp, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 109;
        this.notexp();
...
gramParser.prototype.notexp = function() {
    ...
    this.enterRule(localctx, 24, gramParser.RULE_notexp);
    try {
        this.state = 122;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.rel = function() {
    ...
    this.enterRule(localctx, 26, gramParser.RULE_rel);
    try {
        this.state = 129;
        this._errHandler.sync(this);
...
gramParser.prototype.sum = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 28;
    this.enterRecursionRule(localctx, 28, gramParser.RULE_sum, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 132;
        this.term(0);
...
gramParser.prototype.term = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 30;
    this.enterRecursionRule(localctx, 30, gramParser.RULE_term, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 146;
        this.neg();
...
gramParser.prototype.neg = function() {
    ...
    this.enterRule(localctx, 32, gramParser.RULE_neg);
    try {
        this.state = 159;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.factor = function() {
    ...
    this.enterRule(localctx, 34, gramParser.RULE_factor);
    try {
        this.state = 166;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.return_stmt = function() {
    ...
    this.enterRule(localctx, 36, gramParser.RULE_return_stmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 168;
...
gramParser.prototype.loop = function() {
    ...
    this.enterRule(localctx, 38, gramParser.RULE_loop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 171;
