...
var ruleNames =  [ "start", "program", "decl_list", "func_decl", "optional_param_list", 
                   "optional_expr_list", "var_decl_list", "var_decl", "stmts", 
...
gramParser.RULE_var_decl_list = 6;
gramParser.RULE_var_decl = 7;
gramParser.RULE_stmts = 8;
gramParser.RULE_stmt = 9;
gramParser.RULE_func_call = 10;
gramParser.RULE_builtin_func_call = 11;
gramParser.RULE_assign = 12;
...
gramParser.RULE_rel = 19;
gramParser.RULE_sum = 20;
gramParser.RULE_term = 21;
gramParser.RULE_neg = 22;
gramParser.RULE_factor = 23;
gramParser.RULE_return_stmt = 24;
gramParser.RULE_loop = 25;
...
gramParser.prototype.var_decl_list = function() {
    ...
    this.enterRule(localctx, 12, gramParser.RULE_var_decl_list);
    try {
        this.state = 82;
        this._errHandler.sync(this);
...
gramParser.prototype.var_decl = function() {
    ...
    this.enterRule(localctx, 14, gramParser.RULE_var_decl);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 84;
        this.match(gramParser.TYPE);
...
gramParser.prototype.stmts = function() {
    ...
    this.enterRule(localctx, 16, gramParser.RULE_stmts);
    try {
        this.state = 91;
        this._errHandler.sync(this);
...
gramParser.prototype.stmt = function() {
    ...
    this.enterRule(localctx, 18, gramParser.RULE_stmt);
    try {
        this.state = 107;
        this._errHandler.sync(this);
...
gramParser.prototype.func_call = function() {
    ...
    this.enterRule(localctx, 20, gramParser.RULE_func_call);
    try {
        this.state = 115;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.builtin_func_call = function() {
    ...
    this.enterRule(localctx, 22, gramParser.RULE_builtin_func_call);
    try {
        this.state = 150;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.assign = function() {
    ...
    this.enterRule(localctx, 24, gramParser.RULE_assign);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 152;
        this.match(gramParser.ID);
...
gramParser.prototype.rel = function() {
    ...
    this.enterRule(localctx, 38, gramParser.RULE_rel);
    try {
        this.state = 210;
        this._errHandler.sync(this);
...
gramParser.prototype.sum = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 40;
    this.enterRecursionRule(localctx, 40, gramParser.RULE_sum, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 213;
        this.term(0);
...
gramParser.prototype.term = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 42;
    this.enterRecursionRule(localctx, 42, gramParser.RULE_term, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 227;
        this.neg();
...
gramParser.prototype.neg = function() {
    ...
    this.enterRule(localctx, 44, gramParser.RULE_neg);
    try {
        this.state = 240;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.factor = function() {
    ...
    this.enterRule(localctx, 46, gramParser.RULE_factor);
    try {
        this.state = 250;
        this._errHandler.sync(this);
...
gramParser.prototype.return_stmt = function() {
    ...
    this.enterRule(localctx, 48, gramParser.RULE_return_stmt);
    try {
        this.state = 255;
        this._errHandler.sync(this);
...
gramParser.prototype.loop = function() {
    ...
    this.enterRule(localctx, 50, gramParser.RULE_loop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 257;
